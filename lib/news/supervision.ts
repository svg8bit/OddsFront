...
export const PUBLICATION_JOBS = {
  ...
  telegram: { interval:SOCIAL_PUBLICATION_INTERVAL_MS, grace:15*60_000, file:"telegram/state.json", timestamp:"lastSentAt" },
  "telegram-ru": { interval:SOCIAL_PUBLICATION_INTERVAL_MS, grace:20*60_000, file:"telegram-ru/state.json", timestamp:"lastSentAt" },
  x: { interval:SOCIAL_PUBLICATION_INTERVAL_MS, grace:15*60_000, file:"x/state.json", timestamp:"lastSentAt" },
} as const;
